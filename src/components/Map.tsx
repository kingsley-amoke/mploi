  ...
  const request = requests.find(req => req._id === requestID);
    ...
    return (
      <View style={styles.container}>
        <MapView style={styles.map} region={coordinates} provider={PROVIDER_GOOGLE}>
        ...
        <Fragment>
          ...
          >
            ...
            <Text style={{fontSize:14, color:Colors.dark.onBackground}}>{user.skills[1]}</Text>
              </View>
                ...
                <View>
                  <Text style={{color:Colors.dark.onBackground}}>Request sent, waiting for service provider.</Text>
                </View>
